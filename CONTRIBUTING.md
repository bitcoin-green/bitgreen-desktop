...
First of all, thanks for your interest in helping us build Bitgreen! As more coders are joining our cause, we had to create these guidelines to set some standards and keep everyone on the same track. So here are a few rules and tips to get you started faster and make everyone's life a bit easier.
...
When bug is found or new feature/suggestion proposed, [new Issue gets created](https://github.com/bitgreen/partgui/issues). Our repo has predefined Issue template to help you started with that (the more info you provide the better).
...
When your code is complete and ready, [submit new Pull Request](https://github.com/bitgreen/partgui/compare).
...
- **Icons**
  - all available icons are in [`/src/assets/icons/SVG`](https://github.com/bitgreen/partgui/tree/dev/src/assets/icons/SVG)
